...
public class CheckTimeChart {
	ChartPanel frame1;

	public CheckTimeChart() throws IOException {
		DefaultCategoryDataset xydataset = createDataset();
		JFreeChart jfreechart = ChartFactory.createLineChart("CheckTimeChart",
				"CheckTime(seconds)", "The Number of The Events", xydataset);
	...
	private static DefaultCategoryDataset createDataset() throws IOException { // 这个数据集有点多，但都不难理解
		...
		Aggregation.STEP = 300;
		int x1 = FileIO.getTwoAll("checkTime/aggre_150_80_15", 10);
		int xx1 = FileIO.getTwoAll2("checkTime/aggre_150_80_15", 10);
		int xxx1 = FileIO.getTwoAll3("checkTime/aggre_150_80_15", 10);
		// int y1 = FileIO.getThreeAll("checkTime/aggre_150_80_15", 10);
		int[] es1 = FileIO.getTwoAll4("checkTime/shop_150_80_15", 10);
		int ee1 = FileIO.getTwoAll5("checkTime/shop_150_80_15", 10);
		int[] z1 = FileIO.getTwoAll1("checkTime/shop_150_80_15", 10);
		int[] h1 = FileIO.dataCompare("checkTime", "150_80_15_s-s_");
		int[] e1 = FileIO.dataCompare("checkTime", "150_80_15_e-s_");
		// int[] eess1 = FileIO.dataCompare("checkTime", "150_80_15_e-e_");
		Aggregation.STEP = 400;
		int x2 = FileIO.getTwoAll("checkTime/aggre_150_80_15", 10);
		int xx2 = FileIO.getTwoAll2("checkTime/aggre_150_80_15", 10);
		int xxx2 = FileIO.getTwoAll3("checkTime/aggre_150_80_15", 10);
		// int y2 = FileIO.getThreeAll("checkTime/aggre_150_80_15_", 10);
		// int[] es2 = FileIO.getTwoAll4("checkTime/shop_150_80_15", 10);
		int ee2 = FileIO.getTwoAll5("checkTime/shop_150_80_15", 10);
		// int[] z2 = FileIO.getTwoAll1("checkTime/shop_150_80_15", 10);
		int[] h2 = FileIO.dataCompare("checkTime", "150_80_15_s-s_");
		int[] e2 = FileIO.dataCompare("checkTime", "150_80_15_e-s_");
		// int[] eess2 = FileIO.dataCompare("checkTime", "150_80_15_e-e_");
		Aggregation.STEP = 500;
		int x3 = FileIO.getTwoAll("checkTime/aggre_150_80_15", 10);
		int xx3 = FileIO.getTwoAll2("checkTime/aggre_150_80_15", 10);
		int xxx3 = FileIO.getTwoAll3("checkTime/aggre_150_80_15", 10);
		// int y3 = FileIO.getThreeAll("checkTime/aggre_150_80_15", 10);
		// int[] es3 = FileIO.getTwoAll4("checkTime/shop_150_80_15", 10);
		int ee3 = FileIO.getTwoAll5("checkTime/shop_150_80_15", 10);
		// int[] z3 = FileIO.getTwoAll1("checkTime/shop_150_80_15", 10);
		int[] h3 = FileIO.dataCompare("checkTime", "150_80_15_s-s_");
		int[] e3 = FileIO.dataCompare("checkTime", "150_80_15_e-s_");
		// int[] eess3 = FileIO.dataCompare("checkTime", "150_80_15_e-e_");
		Aggregation.STEP = 600;
		int x4 = FileIO.getTwoAll("checkTime/aggre_150_80_15", 10);
		int xx4 = FileIO.getTwoAll2("checkTime/aggre_150_80_15", 10);
		int xxx4 = FileIO.getTwoAll3("checkTime/aggre_150_80_15", 10);
		// int y4= FileIO.getThreeAll("checkTime/aggre_150_80_15", 10);
		// int[] es4 = FileIO.getTwoAll4("checkTime/shop_150_80_15", 10);
		int ee4 = FileIO.getTwoAll5("checkTime/shop_150_80_15", 10);
		// int[] z4 = FileIO.getTwoAll1("checkTime/shop_150_80_15", 10);
		int[] h4 = FileIO.dataCompare("checkTime", "150_80_15_s-s_");
		int[] e4 = FileIO.dataCompare("checkTime", "150_80_15_e-s_");
		// int[] eess4 = FileIO.dataCompare("checkTime", "150_80_15_e-e_");
		Aggregation.STEP = 700;
		int x5 = FileIO.getTwoAll("checkTime/aggre_150_80_15", 10);
		int xx5 = FileIO.getTwoAll2("checkTime/aggre_150_80_15", 10);
		int xxx5 = FileIO.getTwoAll3("checkTime/aggre_150_80_15", 10);
		// int y5 = FileIO.getThreeAll("checkTime/aggre_150_80_15", 10);
		// int[] es5 = FileIO.getTwoAll4("checkTime/shop_150_80_15", 10);
		int ee5 = FileIO.getTwoAll5("checkTime/shop_150_80_15", 10);
		// int[] z5 = FileIO.getTwoAll1("checkTime/shop_150_80_15", 10);
		int[] h5 = FileIO.dataCompare("checkTime", "150_80_15_s-s_");
		int[] e5 = FileIO.dataCompare("checkTime", "150_80_15_e-s_");
		// int[] eess5 = FileIO.dataCompare("checkTime", "150_80_15_e-e_");
