...
public class Analysis {
	...
	public Analysis() throws IOException {
		...
		JFreeChart jfreechart = ChartFactory.createLineChart("ET2 Chart",
	...
	private static DefaultCategoryDataset createDataset() throws IOException { // 这个数据集有点多，但都不难理解
		...
		int x1 = FileIO.getTwoAll("frequency/aggre_150_80_15_52", 20);
		// int y1 = FileIO.getThreeAll("frequency/aggre_150_80_15_52", 20);
		int[] z1 = FileIO.getTwoAll1("frequency/shop_150_80_15_52", 20);
		int[] h1 = FileIO.dataCompare("frequency", "150_80_15_52");

		int x2 = FileIO.getTwoAll("frequency/aggre_150_80_15_62", 20);
		// int y2 = FileIO.getThreeAll("frequency/aggre_150_80_15_62", 20);
		int[] z2 = FileIO.getTwoAll1("frequency/shop_150_80_15_62", 20);
		int[] h2 = FileIO.dataCompare("frequency", "150_80_15_62");

		int x3 = FileIO.getTwoAll("frequency/aggre_150_80_15_72", 20);
		// int y3 = FileIO.getThreeAll("frequency/aggre_150_80_15_72", 20);
		int[] z3 = FileIO.getTwoAll1("frequency/shop_150_80_15_72", 20);
		int[] h3 = FileIO.dataCompare("frequency", "150_80_15_72");

		int x4 = FileIO.getTwoAll("frequency/aggre_150_80_15_82", 20);
		// int y4 = FileIO.getThreeAll("frequency/aggre_150_80_15_82", 20);
		int[] z4 = FileIO.getTwoAll1("frequency/shop_150_80_15_82", 20);
		int[] h4 = FileIO.dataCompare("frequency", "150_80_15_82");

		int x5 = FileIO.getTwoAll("frequency/aggre_150_80_15_92", 20);
		// int y5 = FileIO.getThreeAll("frequency/aggre_150_80_15_92", 20);
		int[] z5 = FileIO.getTwoAll1("frequency/shop_150_80_15_92", 20);
		int[] h5 = FileIO.dataCompare("frequency", "150_80_15_92");

		int x6 = FileIO.getTwoAll("frequency/aggre_150_80_15_102", 20);
		// int y6 = FileIO.getThreeAll("frequency/aggre_150_80_15_102", 20);
		int[] z6 = FileIO.getTwoAll1("frequency/shop_150_80_15_102", 20);
		int[] h6 = FileIO.dataCompare("frequency", "150_80_15_102");

		int x7 = FileIO.getTwoAll("frequency/aggre_150_80_15_112", 20);
		// int y7 = FileIO.getThreeAll("frequency/aggre_150_80_15_112", 20);
		int[] z7 = FileIO.getTwoAll1("frequency/shop_150_80_15_112", 20);
		int[] h7 = FileIO.dataCompare("frequency", "150_80_15_112");
